...
class User(db.Model):
    ...
    password_plain = db.Column(db.String(255))  # Plain text password for display purposes only
    name = db.Column(db.String(100))  # Full name, required for staff
    role = db.Column(db.String(20), default='user')  # 'user' or 'staff'
